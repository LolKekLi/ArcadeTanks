...
public class TankMovement : MonoBehaviour{
    ...
    public GrodedChecker _grodedChecker = null;
    ...
    private void MoveTank(){
        ...
        if(_grodedChecker.IsGrounded)
        {
            ...
            Vector3 turningTorqueValue = transform.up * (dragTurnCoefficient * turnForwardVelocityCoefficient * turnTorque * (inputs.TurnInput * Time.fixedDeltaTime));
