...
public class CameraController : MonoBehaviour
{
    ...
    public Vector3 GetTargetPosition()
    {
        ...
        //     if (Physics.Raycast(sniperCamera.transform.position, sniperCamera.transform.forward, out RaycastHit hit2,
        //             MaxDistance, ObstaclesLayer))
        //     {
        //         _pos = hit2.point;
    ...
    public Vector3 GetStabilizerPosition()
    {
        ...
        //     if (Physics.Raycast(sniperRigGun.transform.position, sniperRigGun.transform.forward, out RaycastHit hit2,
        //             100f, StabilizerLayer))
        //     {
        //         _pos = hit2.point;
        //     }
        // }
